...
/* package la-dict-0.1.0.0 */
#define VERSION_la_dict "0.1.0.0"
#define MIN_VERSION_la_dict(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "la-dict-0.1.0.0"

#define CURRENT_PACKAGE_KEY "la-dict-0.1.0.0"
